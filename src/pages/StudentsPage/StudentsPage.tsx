...
import { removeUserAccount } from '../../api/authApi';
import { removeStudentFromAllGroups } from '../../api/groupApi';
...
function StudentsPage() {
  ...
  async function confirmDelete() {
    ...
    removeUserAccount(deleteTarget.username);
    removeStudentFromAllGroups(deleteTarget.id);
    ...
    <AppLayout title="دانشجویان">
      ...
      <Modal isOpen={!!deleteTarget} onClose={() => setDeleteTarget(null)}>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          آیا از حذف «{deleteTarget?.name}» مطمئنی؟ حساب ورودش غیرفعال می‌شه و
          از تمام گروه‌هایی که توشون عضوه هم حذف می‌شه. این عملیات قابل بازگشت
          نیست.
        </p>
